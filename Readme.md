...
mkdir temp
cd temp
tar xvfz ../download/OpenSSL_1_0_2u.tar.gz

cd openssl-OpenSSL_1_0_2u
./Configure --prefix=$PWD/../../libs/openssl-1.0.2u linux-x86_64 enable-ssl2 enable-ssl3 enable-weak-ssl-ciphers
make depend
make -j 4
make install
```
